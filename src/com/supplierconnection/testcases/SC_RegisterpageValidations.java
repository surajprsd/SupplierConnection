...
public class SC_RegisterpageValidations {
	...
	public void register(Hashtable<String, String> data) throws IOException{
		...
		if(!TestUtil.isTestCaseExecutable("SC_RegisterpageValidations", xls))
		...
		k.executeKeywords("SC_RegisterpageValidations", xls, data);
}
	...
	public  Object[][] getData(){
		...
		return TestUtil.getData("SC_RegisterpageValidations", xls);
