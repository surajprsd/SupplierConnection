...
public class Showyoursupport {
	...
	public void Showyoursupport1(Hashtable<String, String> data) throws IOException{
		
		if(!TestUtil.isTestCaseExecutable("Showyoursupport", xls))
			throw new SkipException("Flag set to no for testcase"+"Showyoursupport");
		
		//check the runmode of testdata
		if(data.get("RunMode").equals("N"))
			throw new SkipException("Flag set to no");
		
		k.executeKeywords("Showyoursupport", xls, data);
...
public  Object[][] getData(){
	...
	return TestUtil.getData("Showyoursupport", xls);
