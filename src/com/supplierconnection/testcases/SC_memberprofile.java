...
public class SC_memberprofile 
{
	...
	public void step1(Hashtable<String, String> data) throws IOException{
		...
		if(!TestUtil.isTestCaseExecutable("SC_memberprofile", xls))
		...
		k.executeKeywords("SC_memberprofile", xls, data);
}
	
	@DataProvider
	public  Object[][] getDataForSteps(){
		
		return TestUtil.getDataForSteps("SC_memberprofile", xls);
