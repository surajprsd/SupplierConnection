...
public class Events
{
	...
	public void register(Hashtable<String, String> data) throws IOException{
		...
		if(!TestUtil.isTestCaseExecutable("Events", xls))
			throw new SkipException("Flag set to no for testcase"+"Events");
		
		//check the runmode of testdata
		if(data.get("RunMode").equals("N"))
			throw new SkipException("Flag set to no");
		
		k.executeKeywords("Events", xls, data);
}
	...
	public  Object[][] getData(){
		...
		return TestUtil.getData("Events", xls);
