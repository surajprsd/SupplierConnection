...
public class NewFeature {
	...
	public void NewFeature1(Hashtable<String, String> data) throws IOException{
		
		if(!TestUtil.isTestCaseExecutable("NewFeature", xls))
			throw new SkipException("Flag set to no for testcase"+"NewFeature");
		
		//check the runmode of testdata
		if(data.get("RunMode").equals("N"))
			throw new SkipException("Flag set to no");
		
		k.executeKeywords("NewFeature", xls, data);
...
public  Object[][] getData(){
	...
	return TestUtil.getData("NewFeature", xls);
