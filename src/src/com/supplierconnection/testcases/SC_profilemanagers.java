...
public class SC_profilemanagers 
{
	...
	public void SC_profilemanagers(Hashtable<String, String> data) throws IOException{
		...
		if(!TestUtil.isTestCaseExecutable("SC_profilemanagers", xls))
		...
		k.executeKeywords("SC_profilemanagers", xls, data);
	...
	public  Object[][] getDataForSteps(){
		...
		return TestUtil.getData("SC_profilemanagers", xls);
