...
public void step9(Hashtable<String, String> data) throws IOException{
		
		if(!TestUtil.isTestCaseExecutable("SC_step9", xls))
			throw new SkipException("Flag set to no for testcase---"+ "SC_step9");
		
		//check the runmode of testdata
		if(data.get("RunMode").equals("N"))
			throw new SkipException("Flag set to no");
		
		k.executeKeywords("SC_step9", xls, data);
...
public  Object[][] getData(){
	...
	return TestUtil.getDataForSteps("SC_step9", xls);
