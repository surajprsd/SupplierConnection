...
public class SC_profilemanagers_Employeeportal {
	...
	public void SC_profilemanagers(Hashtable<String, String> data) throws IOException{
		...
		if(!TestUtil.isTestCaseExecutable("SC_profilemanagers_Employeeportal", xls))
		...
		k.executeKeywords("SC_profilemanagers_Employeeportal", xls, data);
	...
	public  Object[][] getDataForSteps(){
		...
		return TestUtil.getData("SC_profilemanagers_Employeeportal", xls);
