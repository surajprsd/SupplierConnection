...
public class SC_step7 {
	...
	public void step7(Hashtable<String, String> data) throws IOException{
		//System.out.println(data);
		//check the runmode of testcase
		if(!TestUtil.isTestCaseExecutable("SC_step7", xls))
			throw new SkipException("Flag set to no for testcase"+"SC_step7");
		
		//check the runmode of testdata
		if(data.get("RunMode").equals("N"))
			throw new SkipException("Flag set to no");
		
		k.executeKeywords("SC_step7", xls, data);
	...
	public  Object[][] getDataForSteps(){
		...
		return TestUtil.getDataForSteps("SC_step7", xls);
