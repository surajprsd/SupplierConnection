...
public class SC_step4 {
	...
	public void step1(Hashtable<String, String> data) throws IOException{
		...
		if(!TestUtil.isTestCaseExecutable("SC_step4", xls))
			throw new SkipException("Flag set to no for testcase"+"SC_step4");
		
		//check the runmode of testdata
		if(data.get("RunMode").equals("N"))
			throw new SkipException("Flag set to no");
		
		k.executeKeywords("SC_step4", xls, data);
	...
	public  Object[][] getDataForSteps(){
		...
		return TestUtil.getDataForSteps("SC_step4", xls);
