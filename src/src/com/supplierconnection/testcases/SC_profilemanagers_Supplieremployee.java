...
public class SC_profilemanagers_Supplieremployee {
	...
	public void SC_profilemanagers_Supplieremployee(Hashtable<String, String> data) throws IOException{
		//System.out.println(data);
		//check the runmode of testcase
		if(!TestUtil.isTestCaseExecutable("SC_profilemanagers_Supplieremployee", xls))
		...
		k.executeKeywords("SC_profilemanagers_Supplieremployee", xls, data);
	...
	public  Object[][] getDataForSteps(){
		...
		return TestUtil.getData("SC_profilemanagers_Supplieremployee", xls);
